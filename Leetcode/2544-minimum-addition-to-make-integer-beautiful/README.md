<h2><a href="https://leetcode.com/problems/minimum-addition-to-make-integer-beautiful">Minimum Addition to Make Integer Beautiful</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given two positive integers <code>n</code> and <code>target</code>.</p>
