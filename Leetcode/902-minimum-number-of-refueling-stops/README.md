<h2><a href="https://leetcode.com/problems/minimum-number-of-refueling-stops">Minimum Number of Refueling Stops</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>A car travels from a starting position to a destination which is <code>target</code> miles east of the starting position.</p>
